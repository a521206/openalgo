...
Restart=always
RestartSec=10
StandardOutput=append:$OPENALGO_PATH/log/scheduler.log
StandardError=append:$OPENALGO_PATH/log/scheduler.log

[Install]
WantedBy=multi-user.target
EOL
check_status "Failed to create scheduler systemd service"
